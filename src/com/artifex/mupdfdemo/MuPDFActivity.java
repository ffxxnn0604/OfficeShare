...
public class MuPDFActivity extends Activity implements FilePicker.FilePickerSupport, Observer
{
	...
	enum TopBarMode {Main, Annot, Accept};
	...
	public void createUI(Bundle savedInstanceState) {
		...
		//SS: seekbar control signal sent here!!!!!!!!!!!!
		...
		*/
		...
		//Log.i(TAG, "initial page is: "+prefs.getInt("page"+mFileName, 0));
	...
	*/
	...
	private void makeButtonsView() {
		mButtonsView = getLayoutInflater().inflate(R.layout.mybuttons,null);
